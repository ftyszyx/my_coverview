...
const PreviewTheme = () => {
  ...
  return (
    <div className="w-full h-full bg-white">
      <div className={`overflow-y-hidden flex flex-col px-4 pt-4 w-full h-full`} style={{ backgroundColor: appset.bgColor }}>
        <h1 className={`${appset.title.font} text-2xl md:text-3xl p-10 text-white font-bold text-center`}>{appset.title.text}</h1>
